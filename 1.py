...
img.save('outputs/1/12.png')

img2 = Image.new('RGB', (30, 30), color = (255,0,0))

fnt2 = ImageFont.truetype('font3.ttf', 40)
d2 = ImageDraw.Draw(img2)
d2.text((2,-2), "!", font=fnt2, fill=(255, 255, 255))
img2.save('outputs/1/13.png')
...
img3.save('outputs/1/14.png')


img4 = Image.new('RGB', (30, 30), color = (255,0,0))

fnt4 = ImageFont.truetype('font5.ttf', 40)
d4 = ImageDraw.Draw(img4)
d4.text((2,-2), "!", font=fnt4, fill=(255, 255, 255))
img4.save('outputs/1/15.png')

img5 = Image.new('RGB', (30, 30), color = (255,0,0))

fnt5 = ImageFont.truetype('font6.ttf', 40)
d5 = ImageDraw.Draw(img5)
d5.text((2,-2), "!", font=fnt5, fill=(255, 255, 255))
img5.save('outputs/1/16.png')
