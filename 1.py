...
img.save('outputs/1/4.png')

img2 = Image.new('RGB', (30, 30), color = (255,255,255))

fnt2 = ImageFont.truetype('font3.ttf', 40)
d2 = ImageDraw.Draw(img2)
d2.text((2,-2), "!", font=fnt2, fill=(255, 0, 0))
img2.save('outputs/1/5.png')
...
img4.save('outputs/1/7.png')

img5 = Image.new('RGB', (30, 30), color = (255,255,255))

fnt5 = ImageFont.truetype('font6.ttf', 40)
d5 = ImageDraw.Draw(img5)
d5.text((2,-2), "!", font=fnt5, fill=(255, 0, 0))
img5.save('outputs/1/8.png')
