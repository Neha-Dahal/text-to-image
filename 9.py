...
img2.save('outputs/9/13.png')

img3 = Image.new('RGB', (30, 30), color = (255,0,0))

fnt3 = ImageFont.truetype('font5.ttf', 40)
d3 = ImageDraw.Draw(img3)
d3.text((2,-2), "(", font=fnt3, fill=(255, 255, 255))
img3.save('outputs/9/14.png')
